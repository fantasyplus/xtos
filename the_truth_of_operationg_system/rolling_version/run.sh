...
# 编译init
gcc-4.6 -m32 -I lib/kernel/ -I lib/ -I kernel/ -I device/ -c -fno-builtin -o build/init.o kernel/init.c

# 编译timer
gcc-4.6 -m32 -I lib/kernel/ -I lib/ -I kernel/ -I device/ -c -fno-builtin -o build/timer.o device/timer.c

# 链接成内核
ld -m elf_i386 -Ttext 0xc0001500 -e main -o build/kernel.bin  build/main.o build/kernel.o build/init.o build/interrput.o build/print.o
